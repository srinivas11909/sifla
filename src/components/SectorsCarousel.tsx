...
const sectors = [
  ...
  },
  {
    id: 2,
    name: 'Buffalo',
    image: '/sectors/buffalo-group-river.jpg',
    description: 'Complete buffalo health products',
    products: ['Immunity', 'Milk Enhancers', 'Healthcare']
  },
  {
  ...
  return (
    <section className="py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {/* Swiper Carousel with Round Slides */}
        <motion.div
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.2 }}
          viewport={{ once: true }}
          className="sectors-swiper-container"
        >
          <Swiper
          ...
          >
            {sectors.map((sector) => (
              <SwiperSlide key={sector.id} className="sector-slide">
                <div className="slide-content">
                  ...
                  <div className="circle-container">
                    ...
                    {/* <div className="circle-overlay">
                      <h3 className="text-white font-bold text-sm md:text-base">{sector.name}</h3>
                      <p className="text-white/80 text-[10px] md:text-xs text-center px-2 mt-1 line-clamp-2">{sector.description}</p>
                    </div> */}
                  </div>
                </div>
              </SwiperSlide>
      ...
      {/* Custom Swiper Styles - Perfect Round Circles */}
      <style jsx global>{`
        ...
        /* Make slide background transparent and set auto width */
        .sectors-swiper .sector-slide {
        ...
        /* Perfect Circle Container - Bigger sizes */
        .sectors-swiper .circle-container {
          position: relative;
          width: 140px;
          height: 140px;
          border-radius: 50%;
        ...
        .sectors-swiper .circle-container:hover {
          transform: scale(1.1) translateY(-5px);
          box-shadow: 0 15px 40px rgba(0, 0, 0, 0.4);
          border-color: rgba(255, 255, 255, 0.6);
        }
        
        /* Make sure image fills the circle perfectly */
        .sectors-swiper .circle-image {
          object-fit: cover !important;
          transition: transform 0.5s ease;
        }
        
        .sectors-swiper .circle-container:hover .circle-image {
          transform: scale(1.15);
        }
        
        /* Overlay */
        .sectors-swiper .circle-overlay {
          position: absolute;
          top: 0;
          left: 0;
          right: 0;
        ...
        .sectors-swiper .circle-container:hover .circle-overlay {
          opacity: 1;
        }
        
        /* Pagination */
        .sectors-swiper .swiper-pagination {
          position: relative;
          margin-top: 20px;
          display: flex;
          justify-content: center;
        ...
        /* Responsive circle sizes - all bigger now */
